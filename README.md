...
[![Build Status](https://github.com/airlift/airbase/actions/workflows/ci.yml/badge.svg)](https://github.com/airlift/airbase/actions/workflows/ci.yml?query=event%3Apush+branch%3Amaster)
...
* Airstyle                        (https://github.com/airlift/airstyle)
...
<table>
  ...
  <tr>
    <td>Extended</td>
    <td>Airstyle</td>
    <td><tt>air.check.skip-airstyle</tt></td>
    <td><tt>air.check.fail-airstyle</tt></td>
  </tr>
  <tr>
    <td>Extended</td>
    <td>Checkstyle</td>
